...
namespace ListUnitTest
{
	...
	public:
		...
		TEST_METHOD(pushFrontInto0SizeListThenPopFrontAllElements)
		{
			...
			Assert::AreEqual(8, list.popFront());
		}
		...
		TEST_METHOD(pushFrontInto1SizeListThenPopFrontAllElements)
		{
			...
			Assert::AreEqual(7, list.popFront());
		...
		TEST_METHOD(pushFrontInto2SizeListThenPopFrontAllElements)
		{
			...
			Assert::AreEqual(5, list.popFront());
			Assert::AreEqual(3, list.popFront());
		}
		...
		TEST_METHOD(pushFrontInto5SizeListThenPopFrontAllElements)
		{
			...
			Assert::AreEqual(9, list.popFront());
			Assert::AreEqual(4, list.popFront());
			Assert::AreEqual(7, list.popFront());
			Assert::AreEqual(2, list.popFront());
			Assert::AreEqual(5, list.popFront());
			Assert::AreEqual(3, list.popFront());
		...
		TEST_METHOD(popFrontFrom0SizeListThrowException)
		{
			List<int> list;
			std::function<void(void)> f = [&list] { list.popFront(); };
			Assert::ExpectException<std::exception>(f);
		}

		TEST_METHOD(popFrontFrom1SizeList)
		{
			List<int> list;
			list.pushFront(3);
			Assert::AreEqual( 3, list.popFront() );
		...
		TEST_METHOD(popFrontFrom2SizeListThenPopFrontAllElements)
		{
			List<int> list;
			list.pushFront(3);
			list.pushFront(5);
		...
		TEST_METHOD(popFrontFrom2SizeListThenPopBackAllElements)
		{
			List<int> list;
			list.pushFront(4);
			list.pushFront(1);
		...
		TEST_METHOD(popFrontFrom5SizeListThenPopFrontAllElements)
		{
			List<int> list;
			list.pushFront(3);
			list.pushFront(5);
		...
		TEST_METHOD(popFrontFrom5SizeListThenPopBackAllElements)
		{
			List<int> list;
			list.pushFront(4);
			list.pushFront(1);
		...
		TEST_METHOD(popFrontFrom1SizeListThenNoMemeoryLeak)
		{
			auto pointer = std::make_shared<int>(5);
			List<std::shared_ptr<int>> list;
			list.pushFront(std::shared_ptr<int>(pointer));
		...
		TEST_METHOD(popFrontFrom2SizeListThenNoMemeoryLeak)
		{
			auto pointer = std::make_shared<int>(5);
			List<std::shared_ptr<int>> list;
			list.pushFront(std::shared_ptr<int>(pointer));
		...
		TEST_METHOD(popFrontFrom5SizeListThenNoMemeoryLeak)
		{
			auto pointer = std::make_shared<int>(5);
			List<std::shared_ptr<int>> list;
			list.pushFront(std::shared_ptr<int>(pointer));
